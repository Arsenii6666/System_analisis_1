...
[
  ...
  alive-count   ;; current amount of living cells
  curr-alive    ;; current row alive cells
  max-alive     ;; maximal row alive cells
  steady-state? ;; is the amount of last-row living cells equal to the current row
]
...
to go
  ...
  ask patches with [ pycor = row ]  ;; color in changed cells
    [ color-patch ]
  set steady-state? (curr-alive = get-curr-lives - alive-count)
  set curr-alive get-curr-lives - alive-count
  set alive-count get-curr-lives
  set max-alive max list max-alive curr-alive
  tick
end
...
to-report get-curr-lives
  report count patches with [pcolor != black]
end
...
"" ""
PENS
"Current Turn Alive" 1.0 0 -10899396 true "" "plot curr-alive"
...
setup-continue</setup>
    ...
    <metric>max-alive</metric>
    <enumeratedValueSet variable="OII">
      <value value="true"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="density">
      <value value="100"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="OOI">
      <value value="true"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="IOO">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="background">
      <value value="0"/>
    </enumeratedValueSet>
    <steppedValueSet variable="rule" first="0" step="1" last="255"/>
    <enumeratedValueSet variable="III">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="OIO">
      <value value="true"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="IOI">
      <value value="true"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="OOO">
      <value value="true"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="auto-continue?">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="foreground">
      <value value="55"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="IIO">
      <value value="false"/>
    </enumeratedValueSet>
  </experiment>
</experiments>
